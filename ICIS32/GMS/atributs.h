/* atributs.h : Declares the functions  to access and manipulate the ATRIBUTS table of ICIS
...
LONG getAttribute(BOOL fLocal, GMS_Attribute &atributs, CHAR *szDesc, LONG nszDesc
               , LONG fSearchOption);
